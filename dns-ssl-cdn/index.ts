...
const stackConfig = new pulumi.Config("website-hosting");
const config = {
    ...
    // application load balancer arn, which is used to route trafiic between 2 EC2 instance in different subnets.
    websiteArn: stackConfig.get("websiteArn"),
    // application load balancer endpoint.
    websiteEndpoint: stackConfig.get("websiteEndpoint"),
};
...
let websiteArn: pulumi.Input<string> = config.websiteArn!;
let websiteEndpoint: pulumi.Input<string> = config.websiteEndpoint!;
